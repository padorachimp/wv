	...
	return (function(e) {
		...
		function(e, t, n) {
			...
			function o() {
				function e(t) {
					(e = r.default.noop),
						u.addClass('webvUI-animate-fade-out'),
						a
							.addClass('webvUI-animate-fade-out')
				...
				n = r.default.extend(
					{
						...
						className: '',
						buttons: [
							{ label: '确定', type: 'primary', onClick: r.default.noop }
						],
						isAndroid: i
					},
					n
				...
				return (
					...
					u.addClass('webvUI-animate-fade-in'),
					a.addClass('webvUI-animate-fade-in'),
					o.on('click', '.webvUI-dialog__btn', function(e) {
						var i = (0, r.default)(this).index();
						n.buttons[i].onClick
							? n.buttons[i].onClick.call(this, e) !== !1 && t()
							: t();
					}),
					(s = o[0]),
					(s.hide = t),
				...
				(0, u.default)(s.default.fn, {
					...
					attr: function() {
						...
						if ('object' == a(arguments[0])) {
							...
							if ('object' === ('undefined' == typeof n ? 'undefined' : a(n)))
								return n.v;
						}
							...
							o &&
								r.push.apply(
									...
									o[t]
										...
										: '' + o === o
											? /</.test(o)
												? (((a = e.createElement(a || t)).innerHTML = o),
												  a.children)
												: a
													? (a = i(a)[0])
														? a[n](o)
		...
		function(e, t, n) {
			...
			function o() {
				...
				return (
					...
					i.addClass('webvUI-animate-fade-in'),
					o.addClass('webvUI-animate-fade-in'),
					setTimeout(function() {
						o.addClass('webvUI-animate-fade-out'),
							i
								.addClass('webvUI-animate-fade-out')
								.on('animationend webkitAnimationEnd', function() {
		...
		function(e, t) {
			e.exports =
				'<div class="<%= className %>"> <div class=webvUI-mask_transparent></div> <div class=webvUI-toast> <i class="webvUI-icon_toast webvUI-icon-success-no-circle"></i> <p class=webvUI-toast__content><%=content%></p> </div> </div> ';
		},
		function(e, t, n) {
			'use strict';
			function i(e) {
		...
		function(e, t) {
			e.exports =
				'<div class="webvUI-loading_toast <%= className %>"> <div class=webvUI-mask_transparent></div> <div class=webvUI-toast> <i class="webvUI-loading webvUI-icon_toast"></i> <p class=webvUI-toast__content><%=content%></p> </div> </div> ';
		},
		function(e, t, n) {
			'use strict';
			function i(e) {
			...
			function o() {
				function e(t) {
					(e = r.default.noop),
						d.addClass(
							o.isAndroid
								? 'webvUI-animate-fade-out'
								: 'webvUI-animate-slide-down'
						),
						f
							.addClass('webvUI-animate-fade-out')
							.on('animationend webkitAnimationEnd', function() {
				...
				return (
					...
					d.addClass(
						o.isAndroid ? 'webvUI-animate-fade-in' : 'webvUI-animate-slide-up'
					),
					f.addClass('webvUI-animate-fade-in').on('click', function() {
						t();
					}),
					u
						.find('.webvUI-actionsheet__menu')
						.on('click', '.webvUI-actionsheet__cell', function(e) {
							var i = (0, r.default)(this).index();
							n[i].onClick.call(this, e), t();
						}),
					u
						.find('.webvUI-actionsheet__action')
						.on('click', '.webvUI-actionsheet__cell', function(e) {
		...
		function(e, t) {
			e.exports =
				'<div class="webvUI-toptips webvUI-toptips_warn <%= className %>" style=display:block><%= content %></div> ';
		},
		function(e, t, n) {
			'use strict';
			function i(e) {
		...
		function(e, t, n) {
			...
			function o(e) {
				...
				return (
					(t = r.default.extend(
						{ defaultIndex: 0, onChange: r.default.noop },
						t
					)),
					n.forEach(function(e) {
						...
						i.eq(t.defaultIndex).addClass('webvUI-bar__item_on'),
							o.eq(t.defaultIndex).show(),
							i.on('click', function() {
								var e = (0, r.default)(this),
									n = e.index();
								i.removeClass('webvUI-bar__item_on'),
									e.addClass('webvUI-bar__item_on'),
									o.hide(),
									o.eq(n).show(),
		...
		function(e, t, n) {
			...
			function o(e) {
				return e && e.classList
					? e.classList.contains('webvUI-cell')
						? e
						: o(e.parentNode)
					: null;
			}
			function a(e, t, n) {
				...
				if ('INPUT' == i.tagName || 'TEXTAREA' == i.tagName) {
					...
					if ('radio' == i.type) {
						for (
							var r = t.find('input[type="radio"][name="' + i.name + '"]'),
								u = 0,
								l = r.length;
							u < l;
							++u
					...
					if ('checkbox' != i.type) {
						if (a) {
							if (/^REG_/.test(a)) {
								...
								if (((a = a.replace(/^REG_/, '')), !n[a]))
									throw 'RegExp ' + a + ' has not found.';
								a = n[a];
							}
					...
					if ('object' === ('undefined' == typeof s ? 'undefined' : d(s)))
						return s.v;
			...
			function l(e) {
				if (e) {
					...
					if (
						(i && (0, h.default)(i),
						'checkbox' == e.ele.type || 'radio' == e.ele.type)
					)
						return;
					var a = o(e.ele);
			...
			function o(e, t) {
				function n(e, t) {
					...
					return (
						i.length ||
							((i = (0, r.default)(
								'<div class="webvUI-uploader__file-content"></div>'
							)),
							n.append(i)),
						n.addClass('webvUI-uploader__file_status'),
						i
					);
				}
				function i(e, t) {
					var n = e
						.find('[data-id="' + t + '"]')
						.removeClass('webvUI-uploader__file_status');
				...
				(t = r.default.extend(
					...
					t.compress !== !1 &&
						(t.compress = r.default.extend(
							{ width: 1600, height: 1600, quality: 0.8 },
							t.compress
						)),
					t.onBeforeQueued &&
						!(function() {
							...
							t.onBeforeQueued = function(t, n) {
								...
								if (i !== !0) {
									var o = (0, r.default)(
										r.default.render(l.default, { id: t.id })
									);
					...
					t.onError &&
						!(function() {
							...
							t.onError = function(t, i) {
								(t.status = 'fail'),
									e.call(t, i) ||
										n(a, t.id).html('<i class="webvUI-icon-warn"></i>');
							};
						})(),
		...
		function(e, t) {
			e.exports =
				'<li class="webvUI-uploader__file webvUI-uploader__file_status" data-id="<%= id %>"> <div class=webvUI-uploader__file-content> <i class=webvUI-loading style=width:30px;height:30px></i> </div> </li> ';
		},
		function(e, t) {
			'use strict';
			function n(e) {
			...
			function a(e) {
				...
				for (var n = t.byteLength, i = 2; i < n; ) {
					...
					if (((i += 2), 65505 == o)) {
						...
						i += 2;
						for (var u = 0; u < r; u++)
							if (274 == t.getUint16(i + 12 * u, a))
								return t.getUint16(i + 12 * u + 8, a);
					} else {
					...
					(s.onload = function() {
						...
						if (
							(v < m && m > h
								...
								: v >= m &&
								  v > p &&
								  ((m = parseInt((p * s.height) / s.width)), (v = p)),
							(f.width = v),
							(f.height = m),
							d > 0 && r(f, c, d),
							...
							/;base64,null/.test(y) || /;base64,$/.test(y)
								? (t.onError(
										e,
										new Error('Compress fail, dataURL is ' + y + '.')
								  ),
								  u())
								: ((e.base64 = y), u(e));
					}),
						...
						(v.onreadystatechange = function() {
							if (4 == v.readyState)
								if (200 == v.status)
									...
									r(
										n,
										new Error('XMLHttpRequest response status is ' + v.status)
									);
						}),
			...
			function r() {
				function e() {
					(0, d.default)(r.container).append(v),
						...
						v.find('.webvUI-mask').addClass('webvUI-animate-fade-in'),
						v.find('.webvUI-picker').addClass('webvUI-animate-slide-up');
				}
				function t(e) {
					(t = d.default.noop),
						v.find('.webvUI-mask').addClass('webvUI-animate-fade-out'),
						v
							.find('.webvUI-picker')
							.addClass('webvUI-animate-slide-down')
							.on('animationend webkitAnimationEnd', function() {
				...
				function i(e, t) {
					...
					v.find('.webvUI-picker__group')
						.eq(t)
						.scroll({
							items: e,
							temp: p[t],
							onChange: function(e, n) {
								if ((e ? (c[t] = new a(e)) : (c[t] = null), (p[t] = n), s))
									c.length == y && r.onChange(c);
								else if (e.children && e.children.length > 0)
									v
										.find('.webvUI-picker__group')
										.eq(t + 1)
										.show(),
										!s && i(e.children, t + 1);
								else {
				...
				for (
					...
					b += w.default;
				return (
					v.find('.webvUI-picker__bd').html(b),
					e(),
					s
			...
			function u(e) {
				...
				'number' == typeof t.start
					...
					: 'string' == typeof t.start &&
					  (t.start = new Date(t.start.replace(/-/g, '/'))),
					'number' == typeof t.end
						? (t.end = new Date(t.end + '/12/31'))
						: 'string' == typeof t.end &&
						  (t.end = new Date(t.end.replace(/-/g, '/')));
				...
				do {
					...
					var u = a.value.getFullYear(),
						...
						s = a.value.getDate(),
						f = n(i, 'value', u);
					f || ((f = { label: u, value: u, children: [] }), i.push(f));
					var p = n(f.children, 'value', l);
					p ||
						((p = { label: mn[l - 1], value: l, children: [] }),
						f.children.push(p)),
						p.children.push({ label: s, value: s });
				} while (!a.done);
				return r(i, t);
			}
			Object.defineProperty(t, '__esModule', { value: !0 });
								...
								value: function() {
									for (var e = void 0; ; ) {
										...
										if (this._months.indexOf(t + 1) !== -1)
											...
											this._pointer.setMonth(t + 1), this._pointer.setDate(1);
									}
									return e;
								}
							},
			...
			r.default.fn.scroll = function(e) {
				...
				var a = this,
					...
					h = p.items
						.map(function(e) {
							return (
								'<div class="webvUI-picker__item' +
								(e.disabled ? ' webvUI-picker__item_disabled' : '') +
								'">' +
				...
				if (null !== p.temp && p.temp < p.items.length) {
					var x = p.temp;
					p.onChange.call(this, p.items[x], x),
						(_ = (p.offset - x) * p.rowHeight);
				} else {
					var C = s(p.items);
					p.onChange.call(this, p.items[C], C),
						(_ = d(p.offset, p.rowHeight, p.items));
				}
				l(m, _);
				var M = function(e) {
					...
					_ > t && (_ = t), _ < n && (_ = n);
					for (
						var i = p.offset - _ / p.rowHeight;
						p.items[i] && p.items[i].disabled;

					)
						e > 0 ? ++i : --i;
					(_ = (p.offset - i) * p.rowHeight),
						u(m, 0.3),
						l(m, _),
						p.onChange.call(a, p.items[i], i);
				};
				m = v
					.offAll()
		...
		function(e, t) {
			e.exports =
				'<div class="<%= className %>"> <div class=webvUI-mask></div> <div class=webvUI-picker> <div class=webvUI-picker__hd> <a href=javascript:; data-action=cancel class=webvUI-picker__action>Cancel</a> <a href=javascript:; data-action=select class=webvUI-picker__action id=webvUI-picker-confirm>OK</a> </div> <div class=webvUI-picker__bd></div> </div> </div> ';
		},
		function(e, t) {
			e.exports =
				'<div class=webvUI-picker__group> <div class=webvUI-picker__mask></div> <div class=webvUI-picker__indicator></div> <div class=webvUI-picker__content></div> </div>';
		},
		function(e, t, n) {
			'use strict';
			function i(e) {
			...
			function o(e) {
				...
				var o = (0, r.default)(
					r.default.render(l.default, r.default.extend({ url: e }, i))
				);
				return (
					(0, r.default)('body').append(o),
					o.find('.webvUI-gallery__img').on('click', function() {
						n();
					}),
					o.find('.webvUI-gallery__del').on('click', function() {
						i.onDelete.call(this, e);
					}),
					o.show().addClass('webvUI-animate-fade-in'),
					(s = o[0]),
					(s.hide = n),
					s
				);
		...
		function(e, t) {
			e.exports =
				'<div class="webvUI-gallery <%= className %>"> <span class=webvUI-gallery__img style="background-image:url(<%= url %>)"></span> <div class=webvUI-gallery__opr> <a href=javascript: class=webvUI-gallery__del> <i class="webvUI-icon-delete webvUI-icon_gallery-delete"></i> </a> </div> </div> ';
		},
		function(e, t, n) {
			'use strict';
			function i(e) {
			...
			function o(e) {
				...
				if (
					((t = r.default.extend(
						{ step: void 0, defaultValue: 0, onChange: r.default.noop },
						t
					)),
					void 0 !== t.step &&
						((t.step = parseFloat(t.step)), !t.step || t.step < 0))
				)
					throw new Error('Slider step must be a positive number.');
				if (
					(void 0 !== t.defaultValue && t.defaultValue < 0) ||
					t.defaultValue > 100
				)
