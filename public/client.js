...
window.extAsyncInit = function () {
  ...
  MessengerExtensions.getSupportedFeatures(function success(result) {
    ...
    if (features.indexOf("context") != -1) {
     try { MessengerExtensions.getContext(AppID, function success(thread_context) {
        // success
       try
       {document.getElementById("psid").value = thread_context.psid;
        alert("your id is :" +thread_context.psid);
         document.getElementById("demo").value = "your id is :" +thread_context.psid;
        document.getElementById('submit').addEventListener('click', function () {
         ...
         {MessengerExtensions.requestCloseBrowser(function success() {
           ...
           alert("webview closing");
            ...
            console.log(err);
           document.getElementById("demo").value ='closing webview err'+err
      ...
      catch (err){alert('getcontext err'+err)}
    } else {alert('cant find your id');
